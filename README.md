...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cyberxsboy/CfDaoHang)
...
在CF上面CF的Workers 和 Pages上面部署并设置好项目之后，没有任何问题了，就可以在CF的Workers 和 Pages的设置-->构建 选项当中断开github项目链接，这样，后续github项目上面有文件修改了，也不需要让CF上面已经建好的项目进行重构和设置。
